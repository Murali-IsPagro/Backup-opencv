...
def convert_to_NED(forward, right, down):
...
async def run1(system_addr):
    ...
    while a == 1:
        pos1,pos2,pos3=cv_val()
        n, e, d = convert_to_NED(pos1, pos2, -1.0)
...
def cv_val():
    ...
    if ids is not None and ids[0] == id_to_find:
        ...
        pos1=pos_1a=pos_camera[0]
        pos2=pos_2a=-pos_camera[1]
        pos3=pos_3a=pos_camera[2]
    ...
    return key,pos_1a,pos_2a,pos_3a
        
while True:

    key1,pos_1,pos_2,pos_3=cv_val()
    pos1a=pos_1
    pos2a=pos_2
    pos3a=pos_3
    print("X1=%4.0f  Y1=%4.0f Z1=%4.0f"%(pos1a, pos2a, pos3a))
    ...
    if GPIO.input(27) == 0 :
        loop.run_until_complete(run1(system_addr))'''
