...
while True:
    ...
    if ids is not None and ids[0] == id_to_find:
        ...
        pos_1= float((pos_camera[0]*1)/100.0)
        pos_2= float(-((pos_camera[1]*1)/100.0))
        pos_3= float((pos_camera[2]*1)/100.0)
        
       # print("X.1=%0.4f  Y.1=%0.4f Z.1=%0.4f "%(pos_1, (pos_2), pos_3))
        print("X.1=%f  Y.1=%f Z.1=%f "%(pos_1, pos_2, pos_3))
